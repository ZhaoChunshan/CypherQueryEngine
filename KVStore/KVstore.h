...
public:
    ...
    */
    ...
    //for str2propID
    bool open_str2propID(int _mode);
    ...
    //for propID2str
    bool open_propID2str(int _mode);
    ...
    bool updateInsert_edgeIDlistByidTuple(ID_TUPLE* _id_tuple, TYPE_EDGE_ID *_edgeIDlist, unsigned _len, shared_ptr<Transaction> txn = nullptr);
    ...
    // for eid2spo
    bool open_eid2values(int _mode);
    bool close_eid2values();
    ID_TUPLE* getidTupleByedgeID(TYPE_EDGE_ID _edgeID) const;
    bool setidTupleByedgeID(TYPE_EDGE_ID _edgeID, ID_TUPLE* _id_tuple);
    ...
    // for eidpropID2value
    bool open_eidpropID2value(int _mode);
    ...
    bool setedgeValueByid(TYPE_EDGE_ID _edgeID, TYPE_PROPERTY_ID _propID, GPStore::Value *_value, shared_ptr<Transaction> txn = nullptr);
    bool subedgeValueByid(TYPE_EDGE_ID _edgeID, TYPE_PROPERTY_ID _propID, shared_ptr<Transaction> txn = nullptr);

    // for vid2propID
    bool open_vid2propID(int _mode);
    ...
    // for vidpropID2value
    bool open_vidpropID2value(int _mode);
    ...
    bool setnodeValueByid(TYPE_ENTITY_LITERAL_ID _nodeID, TYPE_PROPERTY_ID _propID, GPStore::Value *&_value, shared_ptr<Transaction> txn = nullptr);
...
// Everything about PStore
    ...
    PStore* propID2str;
    PStore* vid2propID;
    PStore* vidpropID2value;
    PStore* spo2eid;
    PStore* eid2values;
    PStore* eidpropID2value;
...
//	bool removeKey(IVTree* _p_btree, unsigned _key);
    ...
    */
    ...
    bool getValueByKey(PStore* _pstore, const char *_key, unsigned long _klen, char *& _value, unsigned long & _vlen, shared_ptr<Transaction> txn = nullptr) const;
